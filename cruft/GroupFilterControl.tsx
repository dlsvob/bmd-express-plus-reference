// src/components/analysis/GroupFilterControl.tsx
...
interface GroupFilterControlProps {
...
const GroupFilterControl: React.FC<GroupFilterControlProps> = ({
    filterState,
    setFilterState,
    ...
    return (
        <Card title="Group Filter Control">
