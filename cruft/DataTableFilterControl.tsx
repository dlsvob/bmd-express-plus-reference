// src/components/analysis/DataTableFilterControl.tsx
...
const DataTableFilterControl: React.FC<DataTableFilterControlProps> = ({
    filterState,
    setFilterState,
    ...
    return (
        <Card title="Data Table Filter Control">
